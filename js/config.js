...
export const INITIAL_STATE = {
  ...
  persona: {
    name: "Camila Alencar",
    age: 19,
    course: "Ciências Econômicas (1º Semestre)",
    ...
    details: "Estudante de 19 anos, ingressante em Ciências Econômicas na URCA. Reside em Barbalha e se desloca diariamente até o Crato. Recebe R$ 700 de bolsa de Iniciação Científica e gerencia seu primeiro orçamento independente."
  },
  balances: {
  ...
  monthlyOptions: {
    1: [
      { id: "opt_lanche_crato", name: "Lanche na Praça da Sé (Crato)", cost: 45, happiness: 10, stability: 0, desc: "Momento de descompressão com colegas após a aula de Economia." },
      ...
      { id: "opt_livro_contab", name: "Livro de Introdução à Economia no sebo", cost: 50, happiness: 6, stability: 6, desc: "Material de apoio valioso para gabaritar a disciplina de introdução." },
    ...
    2: [
      ...
      { id: "opt_pizza_estudo", name: "Rateio de pizza com o grupo de trabalho", cost: 40, happiness: 10, stability: 0, desc: "Reunião de estudo para o trabalho de Teoria Econômica." },
    ...
    3: [
      ...
      { id: "opt_churrasco_sala", name: "Confraternização da turma de Economia", cost: 70, happiness: 16, stability: -2, desc: "Churrasco no Crato para celebrar a aprovação nas provas intermediárias." },
    ...
    4: [
      ...
      { id: "opt_reserva_ferias", name: "Curso livre de Férias: Análise de Cenários Econômicos", cost: 50, happiness: 6, stability: 6, desc: "Avanço de competências para o próximo semestre de Ciências Econômicas." },
